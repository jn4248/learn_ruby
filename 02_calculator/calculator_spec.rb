...
describe "#multiply" do
  ...
  it "multiplies two numbers of opposite sign" do
    expect(multiply([-4,5])).to eq(-20)
  end

  it "multiplication with zero results in zero" do
...
describe "#power" do
  ...
  it "raises base of zero to the power of another number" do
    expect(power(0,3)).to eq(0)
  end
end

# http://en.wikipedia.org/wiki/Factorial
# assumes argument is zero or a positive integer
